...
export class SignupComponent {
  ...
  ngOnInit(): void {
    ...
    this.signupForm = this.fb.group({
      ...
      customerName: this.fb.control<string>('', [Validators.required,Validators.minLength(3)]),
      customerEmail: this.fb.control<string>('', [Validators.required,Validators.email]),
      customerPhone: this.fb.control<string>('', [Validators.required,Validators.minLength(8)]),
      shippingAddress: this.fb.control<string>('', [Validators.required,Validators.minLength(8)]),
  ...
  signup(){
    ...
    firstValueFrom(this.userSvc.signup(signup))
    .then(
      (status) => {
        console.info(status);
