...
public class UserRepository {
    ...
    public int updateUser(UpdateRequest updateRequest) throws DataAccessException {
        return jTemplate.update(UPDATE_USER_PROFILE, updateRequest.getCustomerEmail(), updateRequest.getCustomerPhone(),
                updateRequest.getShippingAddress(), updateRequest.getGender(), updateRequest.getUserID());
    }
