...
export const productImgURL: string =
  'https://tofu-pokemart.sgp1.digitaloceanspaces.com/tofu-pokemart/sprite/';
export const productImgType: string = '.png';
export const landingImgURL: string =
  'https://tofu-pokemart.sgp1.digitaloceanspaces.com/main/landing/';
...
export const STRIPE_PKEY =
  'pk_test_51NVTe7LGmrz8ddRe7vonmfHtfKnjFEVYr1ayaL8BD0dUNc7SymwixZxTJesrBK9gHIPAu9mm17JG5XErLBI05QF100T3Z8Dq24';

export const HQ_ISS: google.maps.LatLngLiteral = {
  lat: 1.2923021783210697,
  lng: 103.77657727116461,
};
export const GMAP_GEOCODE_URL: string =
  'https://maps.googleapis.com/maps/api/geocode/json?key=';
export const GMAP_JS_URL: string =
